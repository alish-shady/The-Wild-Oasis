...
function CheckinBooking() {
  ...
  useEffect(() => {
    setConfirmedPay(booking?.isPaid ?? false);
  }, [booking?.isPaid]);
    ...
    <>
      ...
      {!hasBreakfast && (
        <Box>
          <Checkbox
            ...
            disabled={addBreakfast || isPending}
            onChange={() => {
      ...
      <Box>
        <Checkbox
          ...
          disabled={confirmedPay || isPending}
          onChange={() => setConfirmedPay((cp) => !cp)}
          id="confirm"
        >
      ...
      <ButtonGroup>
        <Button onClick={handleCheckin} disabled={!confirmedPay || isPending}>
          {isPending ? "..." : `Check in booking #${bookingId}`}
        </Button>
